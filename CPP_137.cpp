...
boost::any compare_one(boost::any a, boost::any b) {
    ...
    else if (any_cast<double>(a) == any_cast<double>(b)) return boost::any(double(0.0));
    else if (any_cast<std::string>(a) == any_cast<std::string>(b)) return boost::any(std::string("None"));
    return b;
}