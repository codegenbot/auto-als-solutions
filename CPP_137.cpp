...
boost::any compare_one(boost::any a, boost::any b) {
    if (a.type() == typeid(int) && b.type() == typeid(float)) {
        ...
        else return boost::any((boost::any_cast<string>(a) < boost::any_cast<string>(b)) ? a : b);
    }
        ...
        else return boost::any((boost::any_cast<int>(a) < boost::any_cast<int>(b)) ? a : b);
    }
        ...
        else return boost::any((boost::any_cast<float>(a) < boost::any_cast<float>(b)) ? a : b);
    }
        ...
        else return boost::any((boost::any_cast<double>(a) < boost::any_cast<double>(b)) ? a : b);
    }
    return boost::any((boost::any_cast<boost::any>(a) < boost::any_cast<boost::any>(b)) ? a : b);
}