...
def stabilize():
    ...
    for step in range(350):
        ...
        if (events[29] > 0 or events[30] > 0) and (vitals["HR"] is not None and vitals["HR"] > 150):
            take_action(9)  # Give Adenosine or other arrhythmia management
            continue
        
        if vitals["Sats"] is not None and vitals["Sats"] < 88:
            take_action(30 if "mask" not in examined_vitals else 29)  # Use NonRebreatherMask or Use BagValveMask
