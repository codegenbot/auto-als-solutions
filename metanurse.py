...
while steps < 350:
    ...
    if events[3] > 0.1 or events[4] > 0.1 or events[5] > 0.1 or events[6] > 0.1:  # Vomit/Blood/Tongue in airway
        airway_confirmed = True
        print(31 if events[4] > 0.1 or events[5] > 0.1 else 39)  # UseYankeurSuctionCatheter or TurnOnDefibrillator
        continue
