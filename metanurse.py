...
def main():
    ...
    while steps < 350:
        ...
        if (vital_signs_measurements[5] < 65 and vital_signs_measurements[5] != 0) or (
            vital_signs_measurements[4] < 20 and vital_signs_measurements[4] != 0
        ):
            print(48)  # Finish
            return
        ...
        if any(event_relevances[i] > 0 for i in [3, 4, 5]):  # Airway issues
            ...
            vital_signs_measurements[6] < 8 and vital_signs_measurements[6] != 0
        ):  # Breathing issues
            print(4)  # ExamineBreathing
        elif (
            vital_signs_measurements[4] < 60 and vital_signs_measurements[4] != 0
        ) or (
            vital_signs_measurements[5] < 88 and vital_signs_measurements[5] != 0
        ):  # Circulation issues
            ...
            if all(
                ...
                for i in range(3)
                if vital_signs_measurements[i] != 0
            ):
                ...
                if (
                    ...
                    and vital_signs_measurements[4] != 0
                ):
                    print(20)  # OpenCirculationDrawer
                elif (
                    vital_signs_measurements[5] < 88
                    and vital_signs_measurements[5] != 0
                ):
