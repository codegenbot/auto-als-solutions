...
def stabilize():
    ...
    required_measurements = {25, 27, 16, 3}  # UseSATsProbe, UseBPCuff, ViewMonitor, ExamineAirway
    ...
    for step in range(max_steps):
        ...
        if vitals["MAP"] is not None and vitals["MAP"] < 60:
            if has_unstable_tachyarrhythmia(events):
                take_action(40 if 40 not in actions_taken else 41)  # Defibrillator Charge or Current Up
            else:
