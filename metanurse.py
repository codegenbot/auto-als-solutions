...
def stabilize():
    ...
    for step in range(350):
        ...
        if not all(key in examined_vitals for key in ["airway", "breathing", "circulation", "disability", "exposure"]):
        ...
        if events[28] > 0 or events[30] > 0 or (vitals["HR"] is not None and (vitals["HR"] > 150 or vitals["HR"] < 40)):
            take_action(9)
            continue
