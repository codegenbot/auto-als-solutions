...
def stabilize():
    ...
    for step in range(350):
        ...
        if values[4] == 0 and "MAP" not in examined_vitals:
            take_action(27)
        ...
        if values[5] == 0 and "Sats" not in examined_vitals:
            take_action(25)
            examined_vitals.add("Sats")
            continue

        if values[5] == 0 and "monitor" not in examined_vitals:
            take_action(16)
        ...
        if values[1] == 0 and "RR" not in examined_vitals:
            take_action(4)
