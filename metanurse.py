...
def stabilize():
    ...
    for step in range(350):
        ...
        if events[3] > 0 and any(events[i] > 0 for i in range(4, 7)):  # Airway events after clear check
