...
def stabilize():
    ...
    for step in range(350):
        ...
        if any(events[i] > 0 for i in airway_events) and "airway" not in examined_vitals:
        ...
        if any(events[i] > 0 for i in circulation_events) and "circulation" not in examined_vitals:
        ...
        if any(events[i] > 0 for i in disability_events) and "disability" not in examined_vitals:
