while True:
    ...
    measured_times = list(resultt (float, observations[39:46]))
    ...
    if measured_times[5] > 0.1 and measured_values[5] < 88:
    ...
    if measured_times[4] > 0.1 and measured_values[4] < 60:
        print(15)  # GiveFluids
        continue
    ...
    # Verify if patient's state is stabilized
    if (
        measured_times[5] > 0.1
        and measured_values[5] >= 88
        and measured_times[6] > 0.1
        and measured_values[6] >= 8
        and measured_times[4] > 0.1
