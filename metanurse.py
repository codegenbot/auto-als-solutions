...
def stabilize_patient(observations):
    ...
    return (
        events,
        vital_signs_values[0] if vital_signs_time[0] > 0 else None,   # Heart rate
        vital_signs_values[1] if vital_signs_time[1] > 0 else None,   # Resp rate
        vital_signs_values[4] if vital_signs_time[4] > 0 else None,   # MAP
        vital_signs_values[5] if vital_signs_time[5] > 0 else None    # Sats
    )
