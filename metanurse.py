...
def stabilize():
    ...
    for step in range(350):
        ...
        if events[3] == 0:  # If AirwayClear has not been assessed
        ...
        # Check for tachyarrhythmia and manage it
        if vitals["HR"] is not None and (vitals["HR"] > 100 or events[28] > 0):
